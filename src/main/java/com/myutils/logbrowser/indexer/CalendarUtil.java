...
public class CalendarUtil {
     ...
     * @throws IllegalArgumentException If the given date elements does not
     ...
     * @param years The amount of years to be added to the given calendar.
     ...
     * @param months The amount of months to be added to the given calendar.
     * Negative values are also allowed, it will just go back in time.
     */
     ...
     * @param days The amount of days to be added to the given calendar.
     * Negative values are also allowed, it will just go back in time.
     */
     ...
     * @param hours The amount of hours to be added to the given calendar.
     * Negative values are also allowed, it will just go back in time.
     */
     ...
     * @param minutes The amount of minutes to be added to the given calendar.
     * Negative values are also allowed, it will just go back in time.
     */
     ...
     * @param seconds The amount of seconds to be added to the given calendar.
     * Negative values are also allowed, it will just go back in time.
     */
     ...
     * @param millis The amount of millis to be added to the given calendar.
     * Negative values are also allowed, it will just go back in time.
     */
     ...
     * @throws IllegalArgumentException If the first calendar is dated after the
     * second calendar.
     */
     ...
     * @throws IllegalArgumentException If the first calendar is dated after the
     * second calendar or if the division factor is less than 1.
     */
