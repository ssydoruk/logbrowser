...
public final class OCSHTTP extends Message {
    ...
    public OCSHTTP(ArrayList<String> messageLines, int fileID) {
    ...
    public boolean fillStat(PreparedStatement stmt) throws SQLException {
        ...
        stmt.setLong(7, getRecHandle());
        stmt.setBoolean(8, isInbound());
        setFieldInt(stmt, 9, Main.getRef(ReferenceType.OCSCAMPAIGN, GetCampaignName()));
        return true;
