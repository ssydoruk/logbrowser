...
public class EditorNotepadPP extends ExternalEditor {

    private final String notepadPath;

    public EditorNotepadPP(String notepadPath) {
...
//        }
            ...
            Logger.getLogger(EditorNotepadPP.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
