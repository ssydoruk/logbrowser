...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="inquirer" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.myutils.logbrowser.inquirer.inquirer %CMD_LINE_ARGS%
